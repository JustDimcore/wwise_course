...
namespace Invector.vCharacterController
{
    public class vThirdPersonAnimator : vThirdPersonMotor
    {
        ...
        private float _isShootingSmoothingRate;
        ...
        public virtual void UpdateAnimator()
        {
            ...
            // change IsShooting smoothly
            _isShootingSmoothingRate = isShooting ? Mathf.Lerp(_isShootingSmoothingRate, 1, 0.1f) : Mathf.Lerp(_isShootingSmoothingRate, 0, 0.1f);
            animator.SetFloat(vAnimatorParameters.IsShooting, _isShootingSmoothingRate);
    ...
    public static partial class vAnimatorParameters
    {
        ...
        public static int IsShooting = Animator.StringToHash("IsShooting");
    }
}