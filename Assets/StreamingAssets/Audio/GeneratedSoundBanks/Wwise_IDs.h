...
namespace AK
{
    ...
    namespace SWITCHES
    {
        namespace FOOTSTEPS_TYPE
        {
            static const AkUniqueID GROUP = 2381450613U;
        ...
        namespace OUTDOOR_INDOOR
        {
            static const AkUniqueID GROUP = 27746551U;
    ...
    namespace BUSSES
    {
        ...
        static const AkUniqueID SCENE_OBJ = 2822202625U;
